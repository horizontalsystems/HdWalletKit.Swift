...
public class ReadOnlyHDWallet {
    ...
    public static func publicKeys(hdPublicKey: HDPublicKey, indices: Range<UInt32>, chain: HDWallet.Chain, curve _: DerivationCurve = .secp256k1) throws -> [HDPublicKey] {
    ...
    public static func publicKeys(extendedPublicKey: String, indices: Range<UInt32>, chain: HDWallet.Chain, curve _: DerivationCurve = .secp256k1) throws -> [HDPublicKey] {
